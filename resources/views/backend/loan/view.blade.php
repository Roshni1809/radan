            ...
            <div class="tab-content">
               <div class="tab-pane active" id="loan_details">
                  ...
                  <table class="table table-bordered mt-4">
                     ...
                     <tr>
                        <td>{{ _lang("Document Charges") }}</td>
                        <td> {{ decimalPlace( ($loan->document_charges / 100) * $loan->applied_amount, currency($loan->currency->name))}}  ( {{ $loan->document_charges }}  % )</td>
                     </tr>
                     <tr>
                        <td>{{ _lang("Other Charges") }}</td>
                        <td> {{ decimalPlace( ($loan->other_charges / 100) * $loan->applied_amount, currency($loan->currency->name))}}  ( {{ $loan->other_charges }}  % )</td>
                     </tr>
                     <tr>
                        <td>{{ _lang("Notes For Other Charges") }}</td>
                        <td>{{ $loan->notes_for_other_charges }}</td>
                     </tr>
                     <tr>
                     ...
                     <tr>
                        ...
                        <td> {{ decimalPlace( ($loan->late_payment_penalties / 100) * $loan->applied_amount, currency($loan->currency->name))}}  ( {{ $loan->late_payment_penalties }}  % )</td>
                     </tr>
                     <!--Custom Fields-->
                     ...
                     <tr>
                        <td>{{ _lang("Branch Account") }}</td>
                        <td>{{ $loan->branchAccount->account_name }}</td>
                     </tr>
                     <tr>
