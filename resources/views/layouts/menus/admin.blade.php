...
<li>
	<a href="javascript: void(0);"><i class="fas fa-building"></i><span>{{ _lang('Branches') }} {!! xss_clean($member_requests) !!}</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
	<ul class="nav-second-level" aria-expanded="false">
		<li class="nav-item"><a class="nav-link" href="{{ route('branches.index') }}">{{ _lang('All Branches') }}</a></li>
		<li class="nav-item"><a class="nav-link" href="{{ route('branch_accounts.index') }}">{{ _lang('Accounts') }}</a></li>
		<li class="nav-item"><a class="nav-link" href="{{ route('branch_account_transactions.index') }}">{{ _lang('View Transactions') }}</a></li>
...
<li>
	...
	<ul class="nav-second-level" aria-expanded="false">
		...
		<li class="nav-item"><a class="nav-link" href="{{ route('reports.daily_report') }}">{{ _lang('Daily Report') }}</a></li>
	</ul>
</li>
