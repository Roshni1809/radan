...
use App\Http\Controllers\BranchAccountTransactionController;
    ...
    Route::group(['middleware' => ['auth', 'verified']], function () {
        ...
        Route::group(['middleware' => ['Email2FA']], function () {
            ...
            Route::group(['middleware' => ['admin', 'demo'], 'prefix' => 'admin'], function () {
                ...
                Route::resource('branch_accounts', BranchAccountController::class);

                //Branch Account Transaction Controller
                Route::resource('branch_account_transactions', BranchAccountTransactionController::class);
            ...
            Route::group(['middleware' => ['permission'], 'prefix' => 'admin'], function () {
                ...
                Route::match(['get', 'post'], 'reports/daily_report', [ReportController::class, 'daily_report'])->name('reports.daily_report');
            });
...
Route::get('/branch/accounts', [BranchAccountController::class, 'getAccountsByBranch'])->name('branch.accounts');
