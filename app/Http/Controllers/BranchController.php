...
class BranchController extends Controller {
    ...
    public function index() {
        ...
        $totalAmount = function($branch) {
            $total_amount = 0;
        $accounts = BranchAccount::where('branch_id', $branch->id)->get();
        ...
        return view('backend.branch.list',  compact('branchs'), ["totalAmount" => $totalAmount]);
    }

    public function accounts() {
        return view('backend.branch.branch_accounts.list', compact(''));
    }
